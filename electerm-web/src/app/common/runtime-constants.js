...
// HarmonyOS (ohos-node) may report platform as 'linux' or 'ohos';
// treat both as linux-like for shell/command purposes.
export const isWin = platform === 'win32'
export const isMac = platform === 'darwin'
export const isLinux = platform === 'linux' || platform === 'ohos' || platform === 'openharmony'
export const isHarmony = platform === 'ohos' || platform === 'openharmony'
