...
// ArkWeb has no handling for blob: URLs / `<a download>`, so the stock
// "download from browser" flow silently does nothing there. Install a native
// saver (public Download directory via window.harmonyNative, with blob-anchor
// fallback on plain web) — sftp/file-item.jsx calls it through
