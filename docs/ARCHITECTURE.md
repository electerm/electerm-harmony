...
The Electron main process entry point, generated by `build/harmony/build.js`:
...
│     │   │   ├── clean (remove work/)                               │
│     │   │   ├── compile (vite + copy + pug) → work/app/assets/     │
...
│     │   └── Verify critical files (index.html, JS, CSS, chunks)    │
│     └── Verify output → web_engine/.../resfile/resources/app/     │
│                                                                    │
│  3. build-app.sh                                                   │
